...
type CentralPeer struct {
	...
	WgPubKey *WGPubKey `protobuf:"bytes,3,opt,name=wgPubKey,proto3" json:"wgPubKey,omitempty"`
...
func (x *CentralPeer) GetWgPubKey() *WGPubKey {
	if x != nil {
		return x.WgPubKey
	}
	return nil
...
func (x *WGPubKey) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WGPubKey) ProtoMessage() {}

func (x *WGPubKey) ProtoReflect() protoreflect.Message {
	mi := &file_api_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WGPubKey.ProtoReflect.Descriptor instead.
func (*WGPubKey) Descriptor() ([]byte, []int) {
	return file_api_proto_rawDescGZIP(), []int{8}
}

func (x *WGPubKey) GetRaw() []byte {
	if x != nil {
		return x.Raw
	}
	return nil
...
var file_api_proto_rawDesc = []byte{
	...
	,
...
var file_api_proto_goTypes = []interface{}{
	...
	(*CanSee)(nil),              // 7: CanSee
	(*WGPubKey)(nil),            // 8: WGPubKey
	(*IPNet)(nil),               // 9: IPNet
	(*AddTokenQ)(nil),           // 10: AddTokenQ
	...
	nil,                         // 19: CanPush.NetworksEntry
	nil,                         // 20: GetStatusS.CsEntry
	nil,                         // 21: GetStatusS.PeerEntry
...
var file_api_proto_depIdxs = []int32{
	...
	9,  // 3: CentralNetwork.ips:type_name -> IPNet
	22, // 4: CentralNetwork.keepalive:type_name -> google.protobuf.Duration
	17, // 5: CentralNetwork.peers:type_name -> CentralNetwork.PeersEntry
	9,  // 6: CentralPeer.allowedIPs:type_name -> IPNet
	8,  // 7: CentralPeer.wgPubKey:type_name -> WGPubKey
	7,  // 8: CentralPeer.canSee:type_name -> CanSee
	18, // 9: AddTokenQ.networks:type_name -> AddTokenQ.NetworksEntry
	11, // 10: AddTokenQ.canPush:type_name -> CanPush
	19, // 11: CanPush.networks:type_name -> CanPush.NetworksEntry
	20, // 12: GetStatusS.cs:type_name -> GetStatusS.CsEntry
	21, // 13: GetStatusS.peer:type_name -> GetStatusS.PeerEntry
	...
	15, // 16: GetStatusS.CsEntry.value:type_name -> CSStatus
	2,  // 17: CentralSource.push:input_type -> PushQ
	10, // 18: CentralSource.addToken:input_type -> AddTokenQ
	1,  // 19: CentralSource.ping:input_type -> PingQS
	13, // 20: Kiriyama.getStatus:input_type -> GetStatusQ
	3,  // 21: CentralSource.push:output_type -> PushS
	12, // 22: CentralSource.addToken:output_type -> AddTokenS
	1,  // 23: CentralSource.ping:output_type -> PingQS
	14, // 24: Kiriyama.getStatus:output_type -> GetStatusS
