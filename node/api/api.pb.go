...
var file_api_proto_rawDesc = []byte{
	...
	0x04, 0x63, 0x69, 0x64, 0x72, 0x32, 0x53, 0x0a, 0x04, 0x4e, 0x6f, 0x64, 0x65, 0x12, 0x1c, 0x0a,
	0x04, 0x61, 0x75, 0x74, 0x68, 0x12, 0x07, 0x2e, 0x41, 0x75, 0x74, 0x68, 0x53, 0x51, 0x1a, 0x07,
	0x2e, 0x41, 0x75, 0x74, 0x68, 0x53, 0x51, 0x28, 0x01, 0x30, 0x01, 0x12, 0x13, 0x0a, 0x03, 0x78,
	...
	0x53, 0x1a, 0x07, 0x2e, 0x50, 0x69, 0x6e, 0x67, 0x51, 0x53, 0x32, 0x5b, 0x0a, 0x0d, 0x43, 0x65,
	0x6e, 0x74, 0x72, 0x61, 0x6c, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x12, 0x18, 0x0a, 0x04, 0x70,
	0x75, 0x6c, 0x6c, 0x12, 0x06, 0x2e, 0x50, 0x75, 0x6c, 0x6c, 0x51, 0x1a, 0x06, 0x2e, 0x50, 0x75,
	0x6c, 0x6c, 0x53, 0x30, 0x01, 0x12, 0x16, 0x0a, 0x04, 0x70, 0x75, 0x73, 0x68, 0x12, 0x06, 0x2e,
	0x50, 0x75, 0x73, 0x68, 0x51, 0x1a, 0x06, 0x2e, 0x50, 0x75, 0x73, 0x68, 0x53, 0x12, 0x18, 0x0a,
...
var file_api_proto_depIdxs = []int32{
	...
	17, // 6: CentralConfig.networks:type_name -> CentralConfig.NetworksEntry
	16, // 7: CentralNetwork.ips:type_name -> IPNet
	19, // 8: CentralNetwork.keepalive:type_name -> google.protobuf.Duration
	18, // 9: CentralNetwork.peers:type_name -> CentralNetwork.PeersEntry
	16, // 10: CentralPeer.allowedIPs:type_name -> IPNet
	15, // 11: CentralPeer.publicKey:type_name -> PublicKey
	13, // 12: CentralConfig.NetworksEntry.value:type_name -> CentralNetwork
	14, // 13: CentralNetwork.PeersEntry.value:type_name -> CentralPeer
	1,  // 14: Node.auth:input_type -> AuthSQ
	5,  // 15: Node.xch:input_type -> XchQ
	7,  // 16: Node.ping:input_type -> PingQS
	8,  // 17: CentralSource.pull:input_type -> PullQ
	10, // 18: CentralSource.push:input_type -> PushQ
	7,  // 19: CentralSource.ping:input_type -> PingQS
	...
	7,  // 25: CentralSource.ping:output_type -> PingQS
